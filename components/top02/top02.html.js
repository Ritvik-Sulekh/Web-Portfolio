      ...
      <div class="top02__funnel">
        ...
        <div class="top02__step top02__step--1">
          ...
          <div class="top02__bar">
            <div class="top02__fill" style="width:100%;background:linear-gradient(90deg,#dc2626,#ef4444)"></div>
          </div>
        </div>
        ...
        <div class="top02__step top02__step--2">
          ...
          <div class="top02__bar">
            <div class="top02__fill" style="width:83%;background:linear-gradient(90deg,#f97316,#fb923c)"></div>
          </div>
        </div>
        ...
        <div class="top02__step top02__step--3">
          ...
          <div class="top02__bar">
            <div class="top02__fill" style="width:21%;background:linear-gradient(90deg,#eab308,#fde047)"></div>
          </div>
        </div>
        ...
        <div class="top02__step top02__step--4">
          ...
          <div class="top02__bar">
            <div class="top02__fill" style="width:2.9%;background:linear-gradient(90deg,#22c55e,#86efac)"></div>
          </div>
        </div>
        ...
        <div class="top02__step top02__step--5">
          ...
          <div class="top02__bar">
            <div class="top02__fill" style="width:0.5%;background:linear-gradient(90deg,#16a34a,#22c55e)"></div>
          </div>
        </div>
