function renderExperience() {
  ...
  return `
    ...
    <section class="exp">
      ...
      <div class="exp__item exp__item--group" data-start="2026-03-01" data-end="">
          <div class="exp__date">
            Mar 2026 — Present
            <span class="exp__duration"></span>
          </div>
          ...
          <div class="exp__content">
            ...
            <div class="exp__roles">
              ...
              <div class="exp__role-item">
                <div class="exp__role-header">
                  <div class="exp__role">Senior Business Analyst (A3)</div>
                  <div class="exp__role-date">Apr 2026 — Present</div>
                </div>
                <div class="exp__desc">Conducting Audits with relevants reports in IT Sales & Operations</div>
              </div>

              <div class="exp__role-divider"></div>

              <div class="exp__role-item">
                <div class="exp__role-header">
                  <div class="exp__role">Marketing Associate (A2)</div>
                  <div class="exp__role-date">Mar 2026 — Mar 2026</div>
                </div>
                <div class="exp__desc">Optimized IT Sales by creating & implementing industry standard-wise SOPs & structures</div>
              </div>
        ...
        <div class="exp__item exp__item--group" data-start="2024-09-01" data-end="2025-01-01">
        <div class="exp__date">
          Sept 2024 — Dec 2024
          <span class="exp__duration"></span>
        </div>
          ...
          <div class="exp__roles">
            ...
            <div class="exp__role-item">
              <div class="exp__role-header">
                ...
                <div class="exp__role-date">Oct 2024 — Dec 2024</div>
              </div>
            ...
            <div class="exp__role-item">
              <div class="exp__role-header">
                ...
                <div class="exp__role-date">Sept 2024 — Sept 2024</div>
              </div>
              <div class="exp__desc">Built various Master files for tracking multiple activities.</div>
            </div>
