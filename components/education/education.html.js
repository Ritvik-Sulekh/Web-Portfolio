  ...
  return `
    ...
    <section class="edu">
      ...
      <div class="edu__list">
        ...
        <!-- Grouped: MBA at IIM Udaipur with gap year -->
        <div class="edu__item edu__item--group">
          <div class="edu__date">
            2021 — 2024
          ...
          <div class="edu__content">
            ...
            <div class="edu__roles">

              <div class="edu__role-item">
                <div class="edu__role-header">
                  <div class="edu__role">Final Year</div>
                  <div class="edu__role-date">2023 — 2024</div>
                </div>
                <div class="edu__desc">Graduated from IIM Udaipur. Specialisation in Marketing & Consulting.</div>
              </div>

              <div class="edu__role-divider"></div>

              <!-- Gap year nested inside -->
              <div class="edu__role-item edu__role-item--gap">
                <div class="edu__role-header">
                  <span class="edu__gap-badge">R. Year</span>
                  <div class="edu__role-date">2022 — 2023</div>
                </div>
              ...
              <div class="edu__role-item">
                <div class="edu__role-header">
                  <div class="edu__role">First Year</div>
                  <div class="edu__role-date">2021 — 2022</div>
                </div>
