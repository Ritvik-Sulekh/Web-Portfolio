      ...
      <div class="portfolio__viewer">
        ...
        <div class="portfolio__bar">
          ...
          <div class="portfolio__bar-right">
            <button class="portfolio__btn" id="btnNormal" title="Lock">
              ⊞ Lock
            </button>
            <button class="portfolio__btn portfolio__btn--active" id="btnSlide" title="Normal">
              ▶ Normal
            </button>
            <button class="portfolio__btn portfolio__btn--fullscreen" id="btnFullscreen" title="Slideshow">
              ⛶ Slideshow
            </button>
          </div>
        </div>
