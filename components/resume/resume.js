...
(function () {
  ...
  /* ── Count resumes and save to localStorage ── */
  const resumeCount = document.querySelectorAll('.resume__card').length;
  localStorage.setItem('count_resumes', resumeCount);

  /* ── Show count badge on page ── */
  const badge = document.getElementById('resumeTotal');
  if (badge) badge.textContent = resumeCount;
