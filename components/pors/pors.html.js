  ...
  return `
    ...
    <section class="pors">
      ...
      <div class="pors__list">
        ...
        <!-- Group 1: Guinness World Record @ Harley's -->
      <div class="pors__item pors__item--group">
        <div class="pors__date">
          Oct 2024 — Dec 2024
          <span class="pors__duration">3 mon</span>
        </div>
        <div class="pors__line"></div>
        <div class="pors__content">
          <div class="pors__org">Guinness World Record @ Harley's Fine Baking</div>
          <div class="pors__roles">

            <div class="pors__role-item">
              <div class="pors__role-header">
                <div class="pors__role">Program Manager</div>
                <div class="pors__role-date">Nov 2024 — Dec 2024</div>
              </div>
              <div class="pors__desc">Won Guinness World Record on 06 Dec 2024</div>
            </div>

            <div class="pors__role-divider"></div>

            <div class="pors__role-item">
              <div class="pors__role-header">
                <div class="pors__role">Project Manager</div>
                <div class="pors__role-date">Oct 2024 — Oct 2024</div>
              </div>
      ...
      <!-- Group 2: Library Committee @ IIM Udaipur -->
      <div class="pors__item pors__item--group">
        <div class="pors__date">
          2022 — 2024
          <span class="pors__duration">2 yrs</span>
        </div>
        <div class="pors__line"></div>
        <div class="pors__content">
          ...
          <div class="pors__roles">
            ...
            <div class="pors__role-item">
              <div class="pors__role-header">
                ...
                <div class="pors__role-date">2023 — 2024</div>
              </div>
              <div class="pors__desc">Led library initiatives and represented student interests at senior level.</div>
            </div>
            ...
            <div class="pors__role-item">
              <div class="pors__role-header">
                ...
                <div class="pors__role-date">2022 — 2023</div>
              </div>
              <div class="pors__desc">Assisted in library operations and student representation.</div>
            </div>
      ...
      <!-- Group 3: Utkrisht Sports Fest. @ IIM Udaipur -->
      <div class="pors__item pors__item--group">
        <div class="pors__date">
          2021-22 & 2023-24
          <span class="pors__duration">2 yrs</span>
        ...
        <div class="pors__content">
          ...
          <div class="pors__roles">
            ...
            <div class="pors__role-item">
              ...
              <div class="pors__desc">Led the design vertical for the annual sports festival.</div>
            </div>
            ...
            <div class="pors__role-item">
              <div class="pors__role-header">
                ...
                <div class="pors__role-date">2021 — 2022</div>
              </div>
              <div class="pors__desc">Contributed to design work for the sports festival as a junior member.</div>
            </div>
