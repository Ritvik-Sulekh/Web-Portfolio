function renderSkills() {
  ...
  const skills = [
    ...
    { id: 27, name: 'SQL',                                category: 'Programming',   level: 70, levelLabel: 'Proficient', cert: 'pages/certifications.html' },
    { id: 28, name: 'HTML',                               category: 'Programming',   level: 70, levelLabel: 'Proficient', cert: null },
    { id: 29, name: 'CSS',                                category: 'Programming',   level: 70, levelLabel: 'Proficient', cert: null },
