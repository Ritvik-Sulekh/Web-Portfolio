function renderSkills() {
  ...
  const skills = [
    ...
    { id: 2,  name: 'Claude (Cowork, Code, API)',         category: 'AI Tools',      level: 100, levelLabel: 'Expert', cert: 'pages/certifications.html' },
    { id: 3,  name: 'ChatGPT (CustomGPT)',                category: 'AI Tools',      level: 100, levelLabel: 'Expert', cert: null },
    { id: 4,  name: 'Grok',                               category: 'AI Tools',      level: 100, levelLabel: 'Expert', cert: null },
    ...
    { id: 10, name: 'Communication & Negotiation',        category: 'Soft Skills',   level: 50, levelLabel: 'Intermediate', cert: null },
    ...
    { id: 18, name: 'HubSpot',                            category: 'Marketing Tools', level: 70, levelLabel: 'Proficient', cert: 'pages/certifications.html' },
    ...
    /* Dev Tools */
    { id: 24, name: 'Linux',                              category: 'Dev Tools',     level: 70, levelLabel: 'Proficient', cert: null },
    { id: 25, name: 'GitHub',                             category: 'Dev Tools',     level: 100, levelLabel: 'Expert', cert: null },

    /* Programming */
    { id: 26, name: 'Python',                             category: 'Programming',   level: 70, levelLabel: 'Proficient', cert: null },
    ...
    { id: 30, name: 'JavaScript',                         category: 'Programming',   level: 70, levelLabel: 'Proficient', cert: null },

    /* Design */
    { id: 31, name: 'CorelDraw',                          category: 'Design',        level: 20, levelLabel: 'Beginner', cert: null },
    { id: 32, name: 'Photoshop',                          category: 'Design',        level: 70, levelLabel: 'Proficient', cert: null },
    { id: 33, name: 'Illustrator',                        category: 'Design',        level: 50, levelLabel: 'Intermediate', cert: null },
    { id: 34, name: 'Figma',                              category: 'Design',        level: 50, levelLabel: 'Intermediate', cert: null },
